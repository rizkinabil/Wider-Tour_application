...
<div class="hero-wrap js-fullheight" style="background-image: url('images/place-4.jpg');" data-stellar-background-ratio="0.5">
					...
					<div class="block-23 mb-3">
						<ul>
							<li><span class="icon icon-map-marker"></span><span class="text">
									<p> <span style="font-weight: bold;"> Telkom University </span> <br> Bojogsoang <br>Kab. Bandung <br> Jawa Barat
									</p>
								</span></li>
							<li><a href="#"><span class="icon icon-phone"></span><span class="text">0821338377</span></a></li>
							<li><a href="#"><span class="icon icon-envelope"></span><span class="text">Faisaltsurya@gmail.com</span></a></li>
						</ul>
					</div>
				</div>
			</div>
